                    ...
                    <div className="contact-section-left-internal">
                        ...
                        <div className="contact-section-left-socials">
                            <button 
                                ...
                                onClick={(e)=>{contactButtonSubtmit(e, isMobile, "email")}}
                            >
                                Email
                            </button>
                            <button 
                                className="contact-section-social-buttons" 
                                onClick={(e)=>{contactButtonSubtmit(e, isMobile, "linkedin")}}
                            >
                                LinkedIn
                            </button>
                            <button 
                                className="contact-section-social-buttons" 
                                onClick={(e)=>{contactButtonSubtmit(e, isMobile, "github")}}
                            >
                                GitHub
                            </button>
                            <button 
                                className="contact-section-social-buttons" 
                                onClick={(e)=>{contactButtonSubtmit(e, isMobile, "youtube")}}
                            >
                                YouTube
                            </button>
                        </div>
